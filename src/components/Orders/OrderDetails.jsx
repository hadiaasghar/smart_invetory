...
//           <h2 className="text-xl font-semibold text-gray-800 mb-4">No Order Selected</h2>
...
//       <p><strong>Total:</strong> ${order.item.quantity * item.price}</p>
...
//         <>
//           <h3 className="mt-6 text-lg font-bold text-gray-800">Order Items</h3>
//           <table className="min-w-full mt-4 border-collapse text-sm">
//             <thead>
//               <tr>
//                 <th className="border px-4 py-2 text-left text-gray-600">Item</th>
...
//                 <th className="border px-4 py-2 text-left text-gray-600">Total</th>
//               </tr>
//             </thead>
//             <tbody>
